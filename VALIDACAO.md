...
|---|---:|---:|---:|---|
| `AtencaoPrimaria/producao-da-ubs-no-sisab-equipe-por-equipe.ipynb` | 11 | 1 | 31s | ✅ funcionando |
| `AtencaoPrimaria/painel-da-aps-programas-do-municipio.ipynb` | 14 | 1 | 8s | ✅ funcionando |
| `AtencaoPrimaria/previne-brasil-indicadores-da-aps.ipynb` | 14 | 2 | 27s | ✅ funcionando |
...
| `SINAN/arboviroses-dengue-chikungunya-zika.ipynb` | 7 | 0 | 28s | ❌ célula 7: Error: TProtocolException: Invalid data |
| `SINAN/decodificar-os-codigos-do-sinan.ipynb` | 14 | 1 | 8s | ✅ funcionando |
| `SINAN/dengue-por-estado-e-mes.ipynb` | 5 | 0 | 16s | ❌ célula 5: OSError: Couldn't deserialize thrift: TProtocolException: Invalid data |
...
| `avancado/arquivos-grandes-e-sql.ipynb` | 3 | 0 | 15s | ❌ célula 3: OSError: Couldn't deserialize thrift: TProtocolException: Invalid data |
...
| `cruzamentos/frio-e-coracao-replicando-um-estudo.ipynb` | 10 | 3 | 953s | ✅ funcionando |
...
| `indicadores/populacao-e-taxas.ipynb` | 6 | 0 | 19s | ❌ célula 6: OSError: Couldn't deserialize thrift: invalid TType |
...
- DERIVA: valor mudou sem o período mudar — olhe:
-   − 4. Funções da origem 'Saúde' que devolvem vazio: 1 de 11 — confere (é o estado conhecido da 2.10.6)
